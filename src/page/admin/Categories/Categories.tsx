...
function Categories() {
    ...
    return (
        <div>
            ...
            <CategoriesTable items={items} status={status} page={page} setPage={setPage} />
            <CategoriesModal open={open} handleClose={handleClose} category={category} setCategory={setCategory} handleSubmit={handleSubmit} />
        </div>
    );
}
